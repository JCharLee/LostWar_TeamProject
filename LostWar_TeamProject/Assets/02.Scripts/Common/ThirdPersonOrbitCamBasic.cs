...
public class ThirdPersonOrbitCamBasic : MonoBehaviour 
{
	...
	public float maxVerticalAngle = 90f;                               // Camera max clamp angle. 
	public float minVerticalAngle = -90f;                              // Camera min clamp angle.
	...
	void Update()
	{
		...
		player.transform.rotation = Quaternion.Euler(0, angleH, 0);
